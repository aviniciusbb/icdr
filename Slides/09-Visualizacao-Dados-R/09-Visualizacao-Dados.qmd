...
Suponha que queiramos combinar vários plots em uma única imagem, uma 
opção bastante simples é atravé do pacote `patchwork`.

![](https://patchwork.data-imaginist.com/reference/figures/logo.png){fig-align="center" width="800"}
